 ...
 * Title of Class: LessonLevel4Frame
 * 
 * Description:
 * The LessonLevel4Frame class is designed to present the first level of educational content within the CAI program. 
...
public class LessonLevel4Frame extends JFrame implements ActionListener {
	...
	private ImageIcon lessonImage = new ImageIcon("images/lesson4.png");
	...
	private void addActionListener(LessonLevel4Frame lessonLevel4Frame) {
	...
	public void actionPerformed(ActionEvent event) {
		...
		// if the finish button is clicked
			...
			if (lessonLevel < 4) {
				...
				FileInput.userDataArray.get(SignUpFrame.userIdentity).setLessonLevel(4);
			}
