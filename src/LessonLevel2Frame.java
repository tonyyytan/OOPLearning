 ...
 * Title of Class: LessonLevel2Frame
 * 
 * Description:
 * The LessonLevel2Frame class is designed to present the first level of educational content within the CAI program. 
...
public class LessonLevel2Frame extends JFrame implements ActionListener {
	...
	private ImageIcon lessonImage = new ImageIcon("images/lesson2.png");
	...
	private void addActionListener(LessonLevel2Frame lessonLevel2Frame) {
	...
	public void actionPerformed(ActionEvent event) {
		...
		// if the finish button is clicked
			...
			if (lessonLevel < 2) {
				...
				FileInput.userDataArray.get(SignUpFrame.userIdentity).setLessonLevel(2);
			}
