 ...
 * Title of Class: LessonLevel1Frame
 * 
 * Description:
 * The LessonLevel1Frame class is designed to present the first level of educational content within the CAI program. 
...
public class LessonLevel1Frame extends JFrame implements ActionListener {
	...
	private ImageIcon lessonImage = new ImageIcon("images/lesson1.png");
	...
	private void addActionListener(LessonLevel1Frame lessonLevel1Frame) {
	...
	public void actionPerformed(ActionEvent event) {
		...
		// if the finish button is clicked
			...
			if (lessonLevel < 1) {
				...
				FileInput.userDataArray.get(SignUpFrame.userIdentity).setLessonLevel(1);
			}
